...
stops_df = stops_df[stops_df['zone_id'] == '2001']  # Ensure '2001' is a string for proper comparison
stops_df = stops_df[(stops_df['stop_lat'].between(-90, 90, inclusive='both')) & (stops_df['stop_lon'].between(-90, 90, inclusive='both'))].copy()

# Check Quality
print("Quality: No. of Empty Values")
print(stops_df.isnull().sum())  # Check for empty values
